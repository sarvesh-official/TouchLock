#!/usr/bin/env swift
// realme-buds-touchlock: Lock or restore touch gestures on OnePlus Nord Buds 3 Pro.
//
// Usage:
...
let budsAddr = "60:55:56:2A:55:7A"
...
guard let device = IOBluetoothDevice(addressString: budsAddr) else {
    print("[!] Could not find OnePlus Nord Buds 3 Pro (\(budsAddr))")
